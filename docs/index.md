...
<nav class="navbar">
    <div class="container nav-inner">
        ...
        <div class="nav-links">
            ...
            <a href="https://github.com/mgks/docmd" class="icon-btn" aria-label="GitHub">
...
<footer class="footer">
    ...
    <div class="container footer-grid">
        ...
        <div class="f-col">
            ...
            <a href="https://github.com/mgks/docmd/releases" class="f-link">Changelog</a>
        </div>
        <div class="f-col">
            <div class="f-head">Community</div>
            <a href="https://github.com/mgks/docmd" class="f-link">GitHub</a>
            <a href="https://github.com/mgks/docmd/issues" class="f-link">Report Issue</a>
